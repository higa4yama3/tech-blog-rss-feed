...
export const FEED_INFO_LIST: FeedInfo[] = [
  ...
  defineFeed({ label: 'Webクリエイターボックス', url: 'https://www.webcreatorbox.com/feed/', tier: 'media', maxItemsInAggregate: 3 }),
  ...
  defineFeed({ label: 'ナゾロジー', url: 'https://nazology.kusuguru.co.jp/feed/', tier: 'media', maxItemsInAggregate: 3 }),
  ...
  defineFeed({ label: '楽天コマース', url: 'https://commerce-engineer.rakuten.careers/feed/category/%E3%83%86%E3%83%83%E3%82%AF' }),
  defineFeed({ label: '窓の杜', url: 'https://forest.watch.impress.co.jp/data/rss/1.0/wf/feed.rdf', tier: 'media', maxItemsInAggregate: 5 }),
  defineFeed({ label: '日経ビジネス', url: 'https://business.nikkei.com/rss/sns/nb.rdf', tier: 'media', maxItemsInAggregate: 5 }),
